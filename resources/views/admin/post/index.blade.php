            ...
            <div class="card-body">
                <form method="POST" action="{{ route('post@create') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('posttitle') is-invalid  @enderror" id="title"
                            name="postTitle" placeholder="Enter post Title" value="{{ old('posttitle') }}">
                        @error('posttitle')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="postDescription" id="description" cols="30" rows="5" placeholder="Enter Description..."
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="postImage" name="postImage"
                            placeholder="Choose a photo" value="{{ old('postImage') }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <tbody>
                        @foreach ($postData as $pdata)
                            <tr>
                                ...
                                <td>
                                    @if ($pdata->image != null)
                                        <img src="{{ asset('storage/postImage/' . $pdata->image) }}" alt=""
                                ...
                                <td>
                                    <a href="{{ route('post@editPage', $pdata->post_id) }}">
                                        <button class="btn btn-sm bg-dark text-white editBtn"><i
